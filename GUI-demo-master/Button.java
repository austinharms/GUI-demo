...
public class Button extends Actor
{
    ...
    public Button(String text, int size, String first, String second)
    {
        ...
        //TODO (54): Initialize the text2 variable to a new GreenfootImage using the message stored in the text variable, the fontSize variable, the color black, and a new Color with 4 0s as parameters ( new Color(0, 0, 0, 0) )
